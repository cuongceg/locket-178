        ...
        body: Stack(
          children: [
                ...
                child: ClipOval(
                  ...
                  child: Material(
                    ...
                    child: IconButton(
                        ...
                        icon:Image.asset("images/profile-user.png",color: Colors.white,height: 30,width: 30,)
                    ),
                  ),
                )
            ),
            Positioned(
                ...
                child: Text("$numberOfLoveDays days",
                ...
                child: ClipOval(
                  ...
                  child: Material(
                    ...
                    child: IconButton(
                        ...
                        icon:const Icon(Icons.location_on,color: Colors.white,size: 25,)
                    ),
                  ),
                )
            ),
